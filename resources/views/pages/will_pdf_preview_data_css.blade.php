                 ...
                 <div class="panel panel-info">
                               ...
                               <div class="panel-body">
								...
								<div class="col-sm-6">
									<div class="checkbox">
										<label>
											<input readonly type="checkbox" value="Single" name="type_of_will" id="single"  style="color: inherit;font: inherit;border:none;margin: 0;line-height: normal;box-sizing: border-box;padding: 0;" onclick="javascript:uncheckjoint(this);" @if($willquestionare[0]->type_of_will=='Single')checked @endif>
											Single
										</label>
									</div>
									<div class="checkbox disabled">
										<label>
											<input readonly type="checkbox" id="joint" name="type_of_will" value="Joint"  style="color: inherit;font: inherit;border:none;margin: 0;line-height: normal;box-sizing: border-box;padding: 0;" onclick="javascript:uncheckSingle(this);" @if($willquestionare[0]->type_of_will=='Joint')checked @endif>
											Joint
										</label>
									</div>
		                         </div>	
										...
										<label class="col-sm-2 control-label">Residential Address/Woonadres</label>
											<div class="col-sm-10">
											   <div style="margin-top:5px">											   	
											   	   <input readonly type="text" name="street_address" id="street_address" class="form-control" placeholder="Street Address/Straatadres" value="{{$Testator[0]->street_address}}" required style="color: inherit;font: inherit;border:none;margin: 0;line-height: normal;">
											   </div>

											   <div style="margin-top:5px">											   	
											   	   <input readonly type="text" name="street_address_line_two" id="street_address_line_two" class="form-control" placeholder="Street Address Line two/Straatadres Line twee" value="{{$Testator[0]->street_address}}" required style="color: inherit;font: inherit;border:none;margin: 0;line-height: normal;">
											   </div>
												
												<div class="col-sm-6" style="margin-top:5px">								   	
											   	   <input readonly type="text" name="city" id="city" class="form-control" placeholder="City/Stad" value="{{$Testator[0]->city}}" required style="color: inherit;font: inherit;border:none;margin: 0;line-height: normal;">
											   </div>
											   <div class="col-sm-6" style="margin-top:5px">								   	
											   	   <input readonly type="text" name="province" id="province" class="form-control" placeholder="Province/Provinsie" value="{{$Testator[0]->province}}" required style="color: inherit;font: inherit;border:none;margin: 0;line-height: normal;">
											   </div>
							        ...
							        <div class="form-group">
										<label class="col-sm-2 control-label">Addtional Details</label>
										   <div class="col-sm-10">
											...
											<input readonly type="text" name="mobile_number" id="mobile_number" class="form-control" placeholder="Mobile Number/Selfoon nommer" value="{{$Testator[0]->mobile_number}}" required style="color: inherit;font: inherit;border:none;margin: 0;line-height: normal;">
											</div>
											<div class="col-sm-3" style="margin-top:5px">
												<input readonly type="text" name="email_number" id="email_number" class="form-control" placeholder="E-mail" value="{{$Testator[0]->email}}" required style="color: inherit;font: inherit;border:none;margin: 0;line-height: normal;">
											</div>
											<div class="col-sm-3" style="margin-top:5px">
												<input readonly type="text" name="employer" id="employer" class="form-control" placeholder="Name of Employer" value="{{$Testator[0]->name_of_employer}}" required style="color: inherit;font: inherit;border:none;margin: 0;line-height: normal;">
											</div>
											<div class="col-sm-3" style="margin-top:5px">
												<input readonly type="text" name="occupation" id="occupation" class="form-control" placeholder="Occupation/Selfoon nommer" value="{{$Testator[0]->occupation}}" required style="color: inherit;font: inherit;border:none;margin: 0;line-height: normal;">
											</div>
                  ...
                  <div class="panel panel-info">
								...
								<div class="panel-body">
                                    ...
                                    <div class="form-group">
										<label class="col-sm-2 control-label">Fullname/Volle naam</label>
											<div class="col-sm-5" style="margin-top:5px">
												<input readonly type="text" name="first_name" id="first_name" class="form-control" placeholder="First Name/Eerste Naam" value="<?php if(isset($testatrix[0])){echo $testatrix[0]->fullname;} ?>" required style="color: inherit;font: inherit;border:none;margin: 0;line-height: normal;">
											</div>
											<div class="col-sm-5" style="margin-top:5px">
												<input readonly type="text" name="second_name" id="second_name" class="form-control" placeholder="Surname/Van" value="<?php if(isset($testatrix[0])){echo $testatrix[0]->surname;} ?>" required style="color: inherit;font: inherit;border:none;margin: 0;line-height: normal;">
											</div>
							        </div>
							        ...
							        <div class="form-group">
										<label class="col-sm-2 control-label">ID Number/ID-nommer</label>
											<div class="col-sm-10" style="margin-top:5px">
												<input readonly type="text" name="id_number" id="id_number" class="form-control" placeholder="ID Number/ID-nommer" value="<?php if(isset($testatrix[0])){echo $testatrix[0]->id_number;} ?>" required style="color: inherit;font: inherit;border:none;margin: 0;line-height: normal;">
											</div>
							        </div>
                                    ...
                                    <div class="form-group">
										<label class="col-sm-2 control-label">Residential Address/Woonadres</label>
											<div class="col-sm-10">
											   <div style="margin-top:5px">											   	
											   	   <input readonly type="text" name="street_address" id="street_address" class="form-control" placeholder="Street Address/Straatadres" value="<?php if(isset($testatrix[0])){$street_address=explode(" :", $testatrix[0]->street_address); echo $street_address[0];} ?>"  style="color: inherit;font: inherit;border:none;margin: 0;line-height: normal;" required>
											   </div>

											   <div style="margin-top:5px">											   	
											   	   <input readonly  type="text" name="street_address_line_two" id="street_address_line_two" class="form-control" placeholder="Street Address Line two/Straatadres Line twee" value="<?php if(isset($testatrix[0])){$street_address=explode(" :", $testatrix[0]->street_address); echo $street_address[1];} ?>"  style="color: inherit;font: inherit;border:none;margin: 0;line-height: normal;"required>
											   </div>
												
												<div class="col-sm-6" style="margin-top:5px">								   	
											   	   <input readonly type="text" name="city" id="city" class="form-control" placeholder="City/Stad" value="<?php if(isset($testatrix[0])){echo $testatrix[0]->city;} ?>" required style="color: inherit;font: inherit;border:none;margin: 0;line-height: normal;">
											   </div>
											   <div class="col-sm-6" style="margin-top:5px">								   	
											   	   <input readonly type="text" name="province" id="province" class="form-control" placeholder="Province/Provinsie" value="<?php if(isset($testatrix[0])){echo $testatrix[0]->province;} ?>" required style="color: inherit;font: inherit;border:none;margin: 0;line-height: normal;">
											   </div>
							        ...
							        <div class="form-group">
										<label class="col-sm-2 control-label">Addtional Details</label>
										   <div class="col-sm-10">
									        ...
									        <div class="col-sm-3" style="margin-top:5px">
                          <h5>Mobile Number/Selfoon nommer:</h5>
											<input readonly type="text" name="mobile_number" id="mobile_number" class="form-control" placeholder="Mobile Number/Selfoon nommer" value="<?php if(isset($testatrix[0])){echo $testatrix[0]->mobile_number;} ?>" required style="color: inherit;font: inherit;margin: 0;line-height: normal;">
											</div>
											<div class="col-sm-3" style="margin-top:5px">
                      <h5>E-mail:</h5>
												<input readonly type="text" name="email_number" id="email_number" class="form-control" placeholder="E-mail" value="<?php if(isset($testatrix[0])){echo $testatrix[0]->email;} ?>" required style="color: inherit;font: inherit;margin: 0;line-height: normal;">
											</div>
											<div class="col-sm-3" style="margin-top:5px">
                       <h5>Name of Employer:</h5>
												<input readonly type="text" name="employer" id="employer" class="form-control" placeholder="Name of Employer" value="<?php if(isset($testatrix[0])){echo $testatrix[0]->name_of_employer;} ?>" required style="color: inherit;font: inherit;margin: 0;line-height: normal;">
											</div>
											<div class="col-sm-3" style="margin-top:5px">
                      <h5>Occupation/Selfoon nommer:</h5>
												<input readonly type="text" name="occupation" id="occupation" class="form-control" placeholder="Occupation/Selfoon nommer" value="<?php if(isset($testatrix[0])){echo $testatrix[0]->occupation;} ?>" required style="color: inherit;font: inherit;margin: 0;line-height: normal;">
											</div>

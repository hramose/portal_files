                 ...
                 <div class="panel panel-info">
                               ...
                               <div class="panel-body">
								...
								<div class="col-sm-6">
									<div class="checkbox">
										<label>
											<input type="checkbox" value="Single" name="type_of_will" id="single"  style="color: inherit;font: inherit;margin: 0;line-height: normal;box-sizing: border-box;padding: 0;" onclick="javascript:uncheckjoint(this);" @if($willquestionare[0]->type_of_will=='Single')checked @endif>
											Single
										</label>
									</div>
									<div class="checkbox disabled">
										<label>
											<input type="checkbox" id="joint" name="type_of_will" value="Joint"  style="color: inherit;font: inherit;margin: 0;line-height: normal;box-sizing: border-box;padding: 0;" onclick="javascript:uncheckSingle(this);" @if($willquestionare[0]->type_of_will=='Joint')checked @endif>
											Joint
										</label>
									</div>
		                         </div>	
								...
								<div class="col-sm-6">
									<div class="checkbox">
										<label>
											<input type="checkbox" value="english" name="language"  style="color: inherit;font: inherit;margin: 0;line-height: normal;box-sizing: border-box;padding: 0;" id="english" onclick="javascript:uncheckAfrikaans(this);" @if($willquestionare[0]->language=='english')checked @endif>
											English
										</label>
									</div>
									<div class="checkbox disabled">
										<label>
											<input type="checkbox" value="afrikaans" id="africans"  style="color: inherit;font: inherit;margin: 0;line-height: normal;box-sizing: border-box;padding: 0;" name="language" onclick="javascript:uncheckEnglish(this);" @if($willquestionare[0]->language=='afrikaans')checked @endif>
											Afrikaans
										</label>
									</div>
		                         </div>	
                                    ...
                                    <div class="form-group">
										<label class="col-sm-2 control-label">Fullname/Volle naam</label>
											<div class="col-sm-5" style="margin-top:5px">
												<input type="text" name="first_name" id="first_name" value="{{$Testator[0]->fullname}}" class="form-control" placeholder="First Name/Eerste Naam" required style="color: inherit;font: inherit;margin: 0;line-height: normal;">
											</div>
											<div class="col-sm-5" style="margin-top:5px">
												<input type="text" name="second_name" id="second_name" value="{{$Testator[0]->surname}}" class="form-control" placeholder="Surname/Van" required style="color: inherit;font: inherit;margin: 0;line-height: normal;">
											</div>
							        </div>
							        ...
							        <div class="form-group">
										<label class="col-sm-2 control-label">ID Number/ID-nommer</label>
											<div class="col-sm-10" style="margin-top:5px">
												<input type="text" name="id_number" id="id_number" class="form-control" value="{{$Testator[0]->id_number}}" placeholder="ID Number/ID-nommer" required style="color: inherit;font: inherit;margin: 0;line-height: normal;">
											</div>
							        </div>
										...
										<label class="col-sm-2 control-label">Residential Address/Woonadres</label>
											<div class="col-sm-10">
											   <div style="margin-top:5px">											   	
											   	   <input type="text" name="street_address" id="street_address" class="form-control" placeholder="Street Address/Straatadres" value="{{$Testator[0]->street_address}}" required style="color: inherit;font: inherit;margin: 0;line-height: normal;">
											   </div>

											   <div style="margin-top:5px">											   	
											   	   <input type="text" name="street_address_line_two" id="street_address_line_two" class="form-control" placeholder="Street Address Line two/Straatadres Line twee" value="{{$Testator[0]->street_address}}" required style="color: inherit;font: inherit;margin: 0;line-height: normal;">
											   </div>
												
												<div class="col-sm-6" style="margin-top:5px">								   	
											   	   <input type="text" name="city" id="city" class="form-control" placeholder="City/Stad" value="{{$Testator[0]->city}}" required style="color: inherit;font: inherit;margin: 0;line-height: normal;">
											   </div>
											   <div class="col-sm-6" style="margin-top:5px">								   	
											   	   <input type="text" name="province" id="province" class="form-control" placeholder="Province/Provinsie" value="{{$Testator[0]->province}}" required style="color: inherit;font: inherit;margin: 0;line-height: normal;">
											   </div>

											   <div class="col-sm-6" style="margin-top:5px">								   	
											   	   <input type="text" name="postal_code" id="postal_code" class="form-control" placeholder="Postal Code/Poskode" value="{{$Testator[0]->postal_code}}" required style="color: inherit;font: inherit;margin: 0;line-height: normal;">
											   </div>
											   <div class="col-sm-6" style="margin-top:5px">								   	
							        ...
							        <div class="form-group">
										<label class="col-sm-2 control-label">Addtional Details</label>
										   <div class="col-sm-10">
											...
											<input type="text" name="mobile_number" id="mobile_number" class="form-control" placeholder="Mobile Number/Selfoon nommer" value="{{$Testator[0]->mobile_number}}" required style="color: inherit;font: inherit;margin: 0;line-height: normal;">
											</div>
											<div class="col-sm-3" style="margin-top:5px">
												<input type="text" name="email_number" id="email_number" class="form-control" placeholder="E-mail" value="{{$Testator[0]->email}}" required style="color: inherit;font: inherit;margin: 0;line-height: normal;">
											</div>
											<div class="col-sm-3" style="margin-top:5px">
												<input type="text" name="employer" id="employer" class="form-control" placeholder="Name of Employer" value="{{$Testator[0]->name_of_employer}}" required style="color: inherit;font: inherit;margin: 0;line-height: normal;">
											</div>
											<div class="col-sm-3" style="margin-top:5px">
												<input type="text" name="occupation" id="occupation" class="form-control" placeholder="Occupation/Selfoon nommer" value="{{$Testator[0]->occupation}}" required style="color: inherit;font: inherit;margin: 0;line-height: normal;">
											</div>
                  ...
                  <div class="panel panel-info">
								...
								<div class="panel-body">
                                    ...
                                    <div class="form-group">
										<label class="col-sm-2 control-label">Fullname/Volle naam</label>
											<div class="col-sm-5" style="margin-top:5px">
												<input type="text" name="first_name" id="first_name" class="form-control" placeholder="First Name/Eerste Naam" value="<?php if(isset($testatrix[0])){echo $testatrix[0]->fullname;} ?>" required style="color: inherit;font: inherit;margin: 0;line-height: normal;">
											</div>
											<div class="col-sm-5" style="margin-top:5px">
												<input type="text" name="second_name" id="second_name" class="form-control" placeholder="Surname/Van" value="<?php if(isset($testatrix[0])){echo $testatrix[0]->surname;} ?>" required style="color: inherit;font: inherit;margin: 0;line-height: normal;">
											</div>
							        </div>
							        ...
							        <div class="form-group">
										<label class="col-sm-2 control-label">ID Number/ID-nommer</label>
											<div class="col-sm-10" style="margin-top:5px">
												<input type="text" name="id_number" id="id_number" class="form-control" placeholder="ID Number/ID-nommer" value="<?php if(isset($testatrix[0])){echo $testatrix[0]->id_number;} ?>" required style="color: inherit;font: inherit;margin: 0;line-height: normal;">
											</div>
							        </div>
                                    ...
                                    <div class="form-group">
										<label class="col-sm-2 control-label">Residential Address/Woonadres</label>
											<div class="col-sm-10">
											   <div style="margin-top:5px">											   	
											   	   <input type="text" name="street_address" id="street_address" class="form-control" placeholder="Street Address/Straatadres" value="<?php if(isset($testatrix[0])){$street_address=explode(" :", $testatrix[0]->street_address); echo $street_address[0];} ?>"  style="color: inherit;font: inherit;margin: 0;line-height: normal;">street_address);  required>
											   </div>

											   <div style="margin-top:5px">											   	
											   	   <input type="text" name="street_address_line_two" id="street_address_line_two" class="form-control" placeholder="Street Address Line two/Straatadres Line twee" value="<?php if(isset($testatrix[0])){$street_address=explode(" :", $testatrix[0]->street_address); echo $street_address[1];} ?>"  style="color: inherit;font: inherit;margin: 0;line-height: normal;"required>
											   </div>
												
												<div class="col-sm-6" style="margin-top:5px">								   	
											   	   <input type="text" name="city" id="city" class="form-control" placeholder="City/Stad" value="<?php if(isset($testatrix[0])){echo $testatrix[0]->city;} ?>" required style="color: inherit;font: inherit;margin: 0;line-height: normal;">
											   </div>
											   <div class="col-sm-6" style="margin-top:5px">								   	
											   	   <input type="text" name="province" id="province" class="form-control" placeholder="Province/Provinsie" value="<?php if(isset($testatrix[0])){echo $testatrix[0]->province;} ?>" required style="color: inherit;font: inherit;margin: 0;line-height: normal;">
											   </div>

											   <div class="col-sm-6" style="margin-top:5px">								   	
											   	   <input type="text" name="postal_code" id="postal_code" class="form-control" placeholder="Postal Code/Poskode" value="<?php if(isset($testatrix[0])){echo $testatrix[0]->postal_code;} ?>" required style="color: inherit;font: inherit;margin: 0;line-height: normal;">
											   </div>
											   <div class="col-sm-6" style="margin-top:5px">								   	
											   	   @include('widgets.dropdown-button', array('class'=>'primary', 'value'=>'Select Country', 'submenu'=> array( 'lists' => array('name' => 'Action', 'link' => '#'),array('name' => 'Another action', 'link' => '#'))))
											   </div>
							        ...
							        <div class="form-group">
										<label class="col-sm-2 control-label">Addtional Details</label>
										   <div class="col-sm-10">
									        ...
									        <div class="col-sm-3" style="margin-top:5px">
											<input type="text" name="mobile_number" id="mobile_number" class="form-control" placeholder="Mobile Number/Selfoon nommer" value="<?php if(isset($testatrix[0])){echo $testatrix[0]->mobile_number;} ?>" required style="color: inherit;font: inherit;margin: 0;line-height: normal;">
											</div>
											<div class="col-sm-3" style="margin-top:5px">
												<input type="text" name="email_number" id="email_number" class="form-control" placeholder="E-mail" value="<?php if(isset($testatrix[0])){echo $testatrix[0]->email;} ?>" required style="color: inherit;font: inherit;margin: 0;line-height: normal;">
											</div>
											<div class="col-sm-3" style="margin-top:5px">
												<input type="text" name="employer" id="employer" class="form-control" placeholder="Name of Employer" value="<?php if(isset($testatrix[0])){echo $testatrix[0]->name_of_employer;} ?>" required style="color: inherit;font: inherit;margin: 0;line-height: normal;">
											</div>
											<div class="col-sm-3" style="margin-top:5px">
												<input type="text" name="occupation" id="occupation" class="form-control" placeholder="Occupation/Selfoon nommer" value="<?php if(isset($testatrix[0])){echo $testatrix[0]->occupation;} ?>" required style="color: inherit;font: inherit;margin: 0;line-height: normal;">
											</div>
				     ...
				     <div class="panel panel-info">
											...
											<div class="col-sm-10">
												<p class="input-group">
													<div class="input-group date" id="datetimepicker" name="datetimepicker">
									                    <input type="text" class="form-control" style="color: inherit;font: inherit;margin: 0;line-height: normal;">
		                       ...
		                       <div class="row">
								...
								<div class="col-sm-10">
									<select class="form-control" name="mariage_type" style="color: inherit;font: inherit;margin: 0;text-transform: none;">
									    <?php 
											...
											<div class="row" style="margin-top:5px">
												...
												<div class="col-sm-10">
													<!-- <div class="panel panel-default"> -->
														...
														<!-- <div class="panel-body"> -->
															<textarea type="text" name="simultaneous_death" id="simultaneous_death" class="form-control text-left" placeholder="First Name/Eerste Naam" rows="5" required style="color: inherit;font: inherit;margin: 0;overflow: auto;"><?php if(isset($will_information[0])){echo $will_information[0]->simultaneous_death;} ?>
															 </textarea>
														<!-- </div> -->
													<!-- </div> -->
										...
										<div class="row" style="margin-top:5px">
												...
												<div class="col-sm-10">
													<!-- <div class="panel panel-default"> -->
														...
														<!-- <div class="panel-body"> -->
															<textarea type="text" name="guardians" id="guardians" class="form-control text-left" placeholder="First Name/Eerste Naam" rows="5" required style="color: inherit;font: inherit;margin: 0;overflow: auto;"><?php if(isset($will_information[0])){echo $will_information[0]->guardians;} ?>
															 </textarea>
														<!-- </div> -->
													<!-- </div> -->
								 ...
								 <div class="row" style="margin-top:5px">
												...
												<div class="col-sm-10">
													<!-- <div class="panel panel-default"> -->
														...
														<!-- <div class="panel-body"> -->
															<textarea type="text" name="other_matters" id="other_matters" class="form-control text-left" placeholder="First Name/Eerste Naam" rows="5" required style="color: inherit;font: inherit;margin: 0;overflow: auto;"><?php if(isset($will_information[0])){echo $will_information[0]->other_matters;} ?>
															 </textarea>
														<!-- </div> -->
													<!-- </div> -->

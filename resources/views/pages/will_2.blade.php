                                    ...
                                    <div class="form-group" >
										<label class="col-sm-2 control-label">Fullname<!-- /Volle naam --></label>
											<div class="col-sm-5" style="margin-top:5px">
												<input type="text" name="first_name" id="first_name" class="form-control" placeholder="First Name" value="<?php if(isset($testatrix[0])){echo $testatrix[0]->fullname;} ?>" required>
											</div>
											<div class="col-sm-5" style="margin-top:5px">
												<input type="text" name="second_name" id="second_name" class="form-control" placeholder="Surname" value="<?php if(isset($testatrix[0])){echo $testatrix[0]->surname;} ?>"  required>
											</div>
							        </div>
							        ...
							        <div class="form-group"  >
										<label class="col-sm-2 control-label">ID Number<!-- /ID-nommer --></label>
											<div class="col-sm-10" style="margin-top:5px">
												<input type="text" name="id_number" id="id_number" class="form-control" placeholder="ID Number" value="<?php if(isset($testatrix[0])){echo $testatrix[0]->id_number;} ?>" required>
											</div>
							        </div>
											...
											<div class="col-sm-10">
											   ...
											   <div  style="margin-top:5px">											   	
												...
												<div  class="col-sm-6" style="margin-top:5px">								   	
											   	   <input type="text" name="city" id="city" class="form-control" placeholder="City"value="<?php if(isset($testatrix[0])){echo $testatrix[0]->city;} ?>" required>
											   </div>
											   <div  class="col-sm-6" style="margin-top:5px">								   	
											   	   <input type="text" name="province" id="province" class="form-control" placeholder="Province" value="<?php if(isset($testatrix[0])){echo $testatrix[0]->province;} ?>" required>
											   </div>

											   <div  class="col-sm-6" style="margin-top:5px">								   	
											   	   <input type="text" name="postal_code" id="postal_code" class="form-control" placeholder="Postal Code" value="<?php if(isset($testatrix[0])){echo $testatrix[0]->postal_code;} ?>" required>
											   </div>
											   <!-- <div  class="col-sm-6" style="margin-top:5px">								   	
							        ...
							        <div class="form-group"  >
										<label class="col-sm-2 control-label">Addtional Details</label>
										   <div   class="col-sm-10">
											...
											<input type="text" name="mobile_number" id="mobile_number" class="form-control" placeholder="Mobile Number" value="<?php if(isset($testatrix[0])){echo $testatrix[0]->mobile_number;} ?>"  required>
											</div>
											<div class="col-sm-3" style="margin-top:5px">
											...
											<div class="col-sm-3" style="margin-top:5px">
												<input type="text" name="occupation" id="occupation" class="form-control" placeholder="Occupation" value="<?php if(isset($testatrix[0])){echo $testatrix[0]->occupation;} ?>" required>
											</div>
											...
											<div class="col-sm-10">
												<p class="input-group">
													<!-- <div class='input-group date' id='datetimepicker' name="datetimepicker"> -->
									                    <input type='text' name="date_marriage"  id="date_marriage" class="form-control" value="<?php echo $mariage_details[0]->marriage_date?>"/>
